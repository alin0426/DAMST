...
def get_args_parser():
    ...
    parser.add_argument('--device', type=int, default='-1', help='device ids of multile gpus, -1 means cpu')
    ...
    parser.add_argument('--wandb_mode', type=str, default="disabled", help='Wandb mode: offline/online')
    ...
    parser.add_argument("--num_heading_bins", type=int, default=16, help="number of heading direction bins")
    parser.add_argument("--fusion_bias_weight", type=float, default=0.05, help="weight for fusion decoding bias")
    
    parser.add_argument(
        "--llm_backbone",
        type=str,
        default="qwen_vl",
        choices=["gpt2", "qwen_vl"],
    )

    parser.add_argument(
        "--qwen_model_path",
        type=str,
        default="/root/work/model/Qwen3.5-4B",
    )
    ...
    parser.add_argument("--qwen_use_lora", type=int, default=1)
    parser.add_argument("--qwen_lora_r", type=int, default=8)
    parser.add_argument("--qwen_lora_alpha", type=int, default=32)
    parser.add_argument("--qwen_lora_dropout", type=float, default=0.1)
    parser.add_argument("--qwen_gradient_checkpointing", type=int, default=1)
